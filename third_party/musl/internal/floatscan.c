...
static long long scanexp(struct scos_scan *f, int pok)
{
	int c;
	int x;
	long long y;
...
static long double decfloat(struct scos_scan *f, int c, int bits, int emin, int sign, int pok)
{
	uint32_t x[KMAX];
...
static long double hexfloat(struct scos_scan *f, int bits, int emin, int sign, int pok)
{
	uint32_t x = 0;
	long double y = 0;
	long double scale = 1;
...
long double __floatscan(struct scos_scan *f, int prec, int pok)
{
	int sign = 1;
	size_t i;
	int bits;
